...
.product_detail_btm2 h4 {
  ...
  height:35px;
    ...
    <div class="section" style="padding:10px 0 10px 0; padding-top: 50px;  ">
      <div class="container d-flex justify-content-center" style="max-width: 540px; background:#fff; padding: 50px ">
        <div class="row">
            ...
            <div class="product_list">
              ...
              <div class="product_detail_btm">
                <div class="center-cam">
                  <h4><?echo substr($post->title,0,50)?></h4>
                </div>
        ...
        <div class="container" style="max-width: 540px; background:#fff; padding: 20px; margin-bottom: 30px">
              ...
              <div class="col-md-12">
                <div class="full">
                  <table class="table head" style="border-top:2px solid #fffffe;">
                    <tr><td>
                          <h3 style="margin: 0 0 5px 0;">Berbagi Bersama Kami</h3>
                      <hr/>
                    </td>
                    </tr></table>
                </div>
            ...
            <div class="row" id="campaign">
              ...
              <div class="swiper-slide">
                <a href="{{route('programed.detail',$post->link)}}">
                <div class="product_list2">
                  ...
                  <div class="product_detail_btm2">
                    ...
                    <p class="center author">{{($post->name)}}<span class="fa fa-check" style="color:#1f5daa;"></span>
