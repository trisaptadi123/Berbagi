    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <form action="{{url('/unggulan')}}" method="POST">
          @csrf
          <div class="row">
          <div class="col-md-4">
          <div class="form-group">
            <label>PIlih Unggulan</label>
            <select class="form-control select2" name="id_konten" style="width: 100%;">
          ...
          <div id="wrapper2">
            ...
            <table id="example1" class="table table-hover">
             ...
             <td>
                ...
                <a class="btn btn-danger" href="{{ url('/hapusunggulan/'.$post->id_konten) }}">Hapus</a>
