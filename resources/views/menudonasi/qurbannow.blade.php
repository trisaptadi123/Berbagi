...
@include('layouts.header')
    ...
    <div class="section padding_layout_1 checkout_section">
		...
		<div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="{{asset('gambarUpload/'.$post->gambar)}}" alt="">
                </div>
    ...
    <div class="col-md-12">
        ...
        <!--    </div>-->
        <!--@endif-->
        <form method="post" action="{{url('bayarqurban')}}" name="qurban" class="coba center">
            <fieldset> 
                @csrf
                            ...
                            <div class="form-field">
                                <div class="detail-don">
                                    ...
                                    <input type="hidden" name="namakonten" class="form-control" id="namakonten"
                                        aria-describedby="namakonten" value="{{($post->judul)}}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-field">
                        <input type="hidden" name="id_qurban" class="form-control" id="id_qurban"
                            aria-describedby="id_konten" value="{{($post->id_qurban)}}">
                    </div>
                </div>
                            ...
                            <div class="form-field">
                               ...
                               <div class="input-group">
                                   <div class="input-group-prepend">
                                       <a class="input-group-btn bb " id="btnmin"  onclick="buttonmin()"><i class="fa fa-minus" style="color:white;"></i></a>
                                       <input type="text" name="jumlah"  style="background:#dddddd; height:35px;" class="form-control"
                                       id="jumlah" aria-describedby="jumlah"  value="1"  required>
                                       <a class="input-group-btn bb" id="btnadd" onclick="buttonplus()" ><i class="fa fa-plus" style="color:white;"></i></a>               
                                   </div>
                               </div>
                                ...
                                <td width="50%">
                                <div class="col-md-12">
                          <p class="mt-3" style="float:right;" >@Rp. <?php echo number_format($post->harga,0,",",".");?></p>
                          </div>
                                </td>
                            </table>
                                <div class="col-md-12">
                                    <div class="form-field">
                                        ...
                                        <input type="hidden" name="harga1" class="harga1" value="{{($post->harga)}}">
                                        <input type="text" name="harga" style="background:#dddddd;"
                                            class="form-control harga" value="Rp. <?php echo number_format($post->harga,0,",",".");?>"   placeholder="Rp.<?php echo number_format($post->harga,0,",",".");?>"
                               ...
                               @if(Request::segment(2) == 'qurban')
                                <div class="col-md-12 mt-2">
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="card-title"><b>Hewan 1</b></h6>
                                            <hr><div class="form-field">
                                            <label>Nama Pequrban</label>
                                            <input type="text" name="nama_qurban[]" style="background:#dddddd;" class="form-control" aria-describedby="nama_qurban" value=""  required>
                                        </div>
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-field">
                                        ...
                                        <input type="text" name="donasi" style="background:#dddddd;" class="form-control"
                                             aria-describedby="total"  id="donasi">
                                        <!-- @if ($errors->has('nama'))
