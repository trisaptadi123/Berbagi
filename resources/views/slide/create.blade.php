          ...
          <div class="card-body">
            ...
            <form method="post" action="{{ url('slide') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="link">Pilih Penempatan</label>
                    <select class="form-control" name="penempatan">
                        <option disabled="" selected="">Pilih Penempatan Slide</option>
                        <option value="slide_atas">Slide Atas</option>
                        <option value="slide_artikel">Slide Artikel</option>
                    </select>
                </div>
                <div class="form-group">
