...
<!--</div>-->
  ...
  <div class="header_bottom">
    ...
    <div class="nav-items justify-content-center">
      ...
      <form action="{{url('cari')}}" method="GET" class="nyumput">
        <input type="search" name="cari" class="cari " placeholder=" Mau berbagi apa hari ini ?" style="width: 220px;padding-right: 50%">
      </form>
      </li>
    </div>
    ...
    <div class="search-icon nyumput2">
      ...
      <form action="{{url('cari')}}" method="GET" class="">
        <input type="search" name="cari" class="cari2" placeholder="Mau berbagi apa hari ini ? ">
      </form>
    </div>
