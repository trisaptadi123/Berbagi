<div class="section nyumput"  style=" background:#fff; margin:5px 0 0 0;  ">
    <div class="container">
        
        <div class="row" id="menu">
          <div class="swiper-container d-flex justify-content-center" style="z-index:0; padding:3px; display: flex; width: 500px; margin: 4px;">
          <div class="swiper-wrapper" >
            ...
            @if(Auth::check())
	        <div class="swiper-slide a_list" style="padding:0;">
            <a href="{{url('buat-galang-dana')}}" class=""><img class="img-responsive" src="{{asset('gambarUpload/galang-o.png')}}"></a>
            </div>
            @else
	        <div class="swiper-slide a_list" style="padding:0;">
