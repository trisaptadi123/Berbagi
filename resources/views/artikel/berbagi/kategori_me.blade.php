...
<div class="row mt-2">
 <div class="center">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right">
            <h4 style="margin-left:15px; font-size:22px; float:left; margin-top:10px;">{{$kategori}}</h4>
    </div>
</div>
</div>
...
<div class="row mt-4" style="margin-bottom:20px;">
 <div class="center">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right">
        <div class="full">
            <center><p style="margin-left:15px; font-size:18px;">Belum ada Artikel</p></center>
        </div>
    </div>
</div>
</div>
