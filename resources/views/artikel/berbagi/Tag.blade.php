...
<div class="row mt-2">
 <div class="center">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right">
            <h4 style="margin-left:15px; font-size:22px; float:left; margin-top:10px;">{{$tag}}</h4>
            @if(Auth::check())
...
<?php if($list_artikel->count() == 0) { ?>
<div class="row mt-4" style="margin-bottom:20px;">
 <div class="center">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right">
        <div class="full">
            <center><p style="margin-left:15px; font-size:18px;">Belum ada Tag</p></center>
        </div>
    </div>
</div>
</div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin_bottom_30_all box-1" >
            ...
            <?php $char = array(" ");
                  ...
                  <?php
                    ...
                    <p style="margin-top: -20px; font-size: 12px;">{{($artikel->name)}} <span class="fa fa-check" style="color:#1f5daa;"></span></p>
...
<div class="row">
 <div class="center">
     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-right" style="margin-bottom:50px;">
        <div class="full">
      <div class="row box-hyu" style="margin-bottom: -20px;">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin_bottom_30_all box-1" >
          ...
          <div class="row" style="width :100%; color : grey">
                @foreach ($tagiall as $tag)
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 " style="margin-top:10px; font-size:12px;">
            <?php $nama_kate = strtoupper($tag->name); ?>
            <a href="{{url('berbagiinfo')}}/{{$tag->name}}">{{$nama_ta}}</a>
          </div>
            @endforeach
          </div>
        </div>
