...
<div class="section product_detail" style="padding-bottom:75px; margin-bottom:10px;">
  <div class="container" style="max-width: 510px; background: #fff; padding-top:30px;">
    <div class="row">
  <div class="center">
      <div class="col-lg-11 col-md-12 col-sm-12 col-xs-12 pull-right">
        <div class="full">
          <a href="{{url('berbagiinfo')}}">Berbagi Info  <i class="fa fa-chevron-right" style="color:#1f5daa"></i></a> <a href="{{url('berbagiinfo')}}/{{$kategori->name}}">{{$kategori->name}}</a>
          <div class="blog_section margin_bottom_0 mt-2">
            ...
            <div class="blog_feature_cantant">
              ...
              <div>
              <a href="{{url('berbagiinfo')}}"> (Tags) <a href="{{url('berbagiinfo')}}/{{$tag ?? ''}}">{{$tag ?? ''}}</a>
              </div>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                    <div style="background:#1f5daa; left:12.5px; color: #fff;padding:10px; width:fit-content;display: flex;align-items: center; border-top-left-radius:10px; border-bottom-right-radius:10px; margin-bottom : 15px;">
                        Kategori Berbagi Info 2
                    </div>
                    <div class="row" style="width :100%; color : grey">
                     @foreach ($kategoriall as $kategori)
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 " style="margin-top:10px; font-size:12px;">
